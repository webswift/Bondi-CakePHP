...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Groups User'), array('action' => 'delete', $groupsUser['GroupsUser']['id']), array(), __('Are you sure you want to delete # %s?', $groupsUser['GroupsUser']['id'])); ?> </li>
